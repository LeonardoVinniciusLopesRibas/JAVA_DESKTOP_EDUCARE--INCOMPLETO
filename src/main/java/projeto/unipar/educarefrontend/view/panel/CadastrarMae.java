...
public class CadastrarMae extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jcbPodeBuscar.setText("Mãe pode buscar");
        add(jcbPodeBuscar);
        ...
        jLabel4.setText("Telefone da Mãe");
        add(jLabel4);
        jLabel4.setBounds(30, 120, 100, 16);

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Cpf da Mãe");
        add(jLabel3);
        ...
        jcbSelectPaiMae.setText("Pai mora  no mesmo endereço?");
        add(jcbSelectPaiMae);
